            ...
            <ScrollView contentContainerStyle={styles.container}>
                ...
                <View style={{ marginVertical: 15, }}>
                    ...
                    <View style={{ marginLeft: 10 }}>
                        <SettingsList
                            upText="Verification"
                            downText="View or update verification document"
                        />
                        <SettingsList
                            upText="Edit Profile"
                        ...
                        <SettingsList
                            ...
                            downText="Manage Your Notifications"
                        />
                        <SettingsList
                            upText="About"
                            downText="Learn more about Sela and the App"
                        />
                        <SettingsList
                            upText="Support"
                            downText="Contact support for help with any issue"
                        />
