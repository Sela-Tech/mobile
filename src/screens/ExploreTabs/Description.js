  ...
  <ScrollView style={styles.container} contentContainerStyle={{ flexGrow: 1 }}>
    <View style={{ marginTop: '4%', flex: 1 }}>
      <Text style={{ color: '#222829' }}>
        This project involves the construction of three classroom blocks at the Surulere Grammar
        School, Lagos. These classroom blocks will house five classrooms, one staff room and two
